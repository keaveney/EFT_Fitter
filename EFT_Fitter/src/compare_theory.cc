...
int main(){
    ...
    make_plot("p_{T}^{#bar{t}}","GeV","data/abs/DiffXS_HypAntiToppT_source.root","abs", preds_antitop_pt, pred_names_antitop_pt,divide_options_antitop_pt, plot_options_antitop_pt);
    
    make_plot("p_{T}^{#bar{t}}","GeV","data/norm/DiffXS_HypAntiToppT_source.root","norm", preds_antitop_pt, pred_names_antitop_pt,divide_options_antitop_pt, plot_options_antitop_pt_norm);
    ...
    make_plot("m_{t#bar{t}}","GeV","data/abs/DiffXS_HypTTBarMass_source.root","abs", preds_mtt, pred_names_mtt,divide_options_mtt, plot_options_mtt);
    
    make_plot("m_{t#bar{t}}","GeV","data/norm/DiffXS_HypTTBarMass_source.root","norm", preds_mtt, pred_names_mtt,divide_options_mtt, plot_options_mtt_norm);

    make_plot("p^{t#bar{t}}_{T}","GeV","data/abs/DiffXS_HypTTBarpT_source.root","abs", preds_pttt, pred_names_pttt,divide_options_pttt, plot_options_pttt);
    
    make_plot("p^{t#bar{t}}_{T}","GeV","data/norm/DiffXS_HypTTBarpT_source.root","norm", preds_pttt, pred_names_pttt,divide_options_pttt, plot_options_pttt_norm);

    make_plot("y_{t#bar{t}}","","data/abs/DiffXS_HypTTBarRapidity_source.root","abs", preds_ytt, pred_names_ytt,divide_options_ytt, plot_options_ytt);
    make_plot("y_{t#bar{t}}","","data/norm/DiffXS_HypTTBarRapidity_source.root","norm", preds_ytt, pred_names_ytt,divide_options_ytt, plot_options_ytt_norm);
